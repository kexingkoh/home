...
<head>
    ...
    <style>
        ...
        /* Removed the card-footer and button styles */
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="card-grid">
            ...
            foreach ($healthImprovementSteps as $index => $step) {
                ...
                echo "</div>";
                // Removed the card-footer and "Learn More" button
                echo "</div>";
            }
            ?>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // If you want any functionality on click events or interactivity, you can add it here.
        });
    </script>
</body>
</html>
